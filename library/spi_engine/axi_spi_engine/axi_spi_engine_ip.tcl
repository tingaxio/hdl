...
set_property -dict [list \
  "value_validation_type" "pairs" \
  "value_validation_pairs" { \
      "Synchronous SPI clock" "0" \
      "Asynchronous SPI clock" "1" \
    } \
 ] \
...
set_property -dict [list \
  ...
  "tooltip" "Define the relationship between the core clock and the memory mapped interface clock" \
...
set_property -dict [list \
  ...
  "tooltip" "Define the depth of the FIFO" \
